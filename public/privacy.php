...
<head>
    ...
    <title>Privacy Policy — PDF to Text Converter</title>
    <meta name="description" content="Privacy Policy for the PDF to Text Converter. No data retained, no cookies, no tracking. Uploaded files are deleted immediately after conversion.">
    ...
    <style>
        ...
        .highlight-box { background: var(--surface); border: 1px solid var(--border); border-left: 3px solid var(--accent); border-radius: 8px; padding: 1.25rem 1.5rem; margin: 1.5rem 0; box-shadow: 0 1px 4px rgba(26,26,46,0.05); }
